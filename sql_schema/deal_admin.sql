...
CREATE TABLE `fund_lp` (
    ...
    `gb_sign_memo` text DEFAULT NULL COMMENT 'GP&管理人已章备注',
    `aic_material_memo` text DEFAULT NULL COMMENT '工商变更资料提供备注',
    `lpac_commission_memo` text DEFAULT NULL COMMENT 'LPAC委任书备注',
    `entrust_agreement_memo` text DEFAULT NULL COMMENT '委托管理协议备注',
    `bank_entrustment_memo` text DEFAULT NULL COMMENT '银行托管信息页备注',
    `no_entrustment_memo` text DEFAULT NULL COMMENT '不托管协议备注',
    ...
    `investor_type_memo` text DEFAULT NULL COMMENT '投资者类型确认备注',
    ...
    `coolingoff_period` varchar(8) DEFAULT NULL COMMENT '冷静期',
    `review` varchar(8) DEFAULT NULL COMMENT '回访',
    `review_memo` text DEFAULT NULL COMMENT '回访备注',
...
CREATE TABLE `compliance_matter` (
    ...
    `limit_source_memo` text DEFAULT NULL COMMENT '限制来源备注', 
    `limit_source_type` text DEFAULT NULL COMMENT '限制来源类型', 
    ...
    `potence` varchar(8) DEFAULT NULL COMMENT '效力情况', 
    `expiry` varchar(32) DEFAULT NULL COMMENT '有效期', 
    `expiry_memo` text DEFAULT NULL COMMENT '有效期备注', 
