        ...
        if (!self::$fieldsMap) {
            self::$fieldsMap = [
                ...
                ['name'=>'_financing_no','label'=>'源码投后融资轮次','type'=>'rawText','default'=>null,'required'=>false,'field'=>function($model) {
                    ...
                    $investExit->setCols('turn_sub');
                    $investExit->addComputedCol('DISTINCT(t)', 'total_amount');
                ...
                ['name'=>'_hold_status','label'=>'持有状态','type'=>'rawText','required'=>false,'field'=>function($model){
                    return '公式待讨论';
                }],
                ['name'=>'_multi_entity_invest','label'=>'是否多主体投过','type'=>'rawText','default'=>null,'required'=>false,'help'=>'历史情况'],
                ['name'=>'_multi_entity_hold','label'=>'当前是否多主体持股','type'=>'rawText','default'=>null,'required'=>false,'help'=>'最新情况'],
