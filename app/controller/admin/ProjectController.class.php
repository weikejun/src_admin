...
class ProjectController extends Page_Admin_Base {
    ...
    public function __construct(){
        ...
        $this->form=new Form(array(
            ...
            array('name'=>'info_right','label'=>'信息权','type'=>"choice",'choices'=>[['有','有'],['无','无']],'required'=>false,),            
            array('name'=>'info_right_threshold','label'=>'信息权门槛','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'field-index-plan','label'=>'投资方案', 'type'=>'seperator'),
            array('name'=>'currency','label'=>'计价货币','type'=>"choice",'choices'=>[['USD','USD'],['RMB','RMB'],['HKD','HKD']],'required'=>false,),
            array('name'=>'pre_money','label'=>'公司投前估值','type'=>"text",'required'=>false,),
            ...
            array('name'=>'entity_id','label'=>'源码投退主体','type'=>"choosemodel",'model'=>'Model_Entity','default'=>$_GET['entity_id']?$_GET['entity_id']:0,'required'=>false,),
            array('name'=>'rmb_usd','label'=>'RMB/USD','type'=>"choice",'choices'=>[['RMB','RMB'],['RMB-ODI','RMB-ODI'],['USD','USD'],['USD-JV','USD-JV'],['USD-VIE','USD-VIE'],['USD-拆VIE','USD-拆VIE'],['其他','其他']],'required'=>false,),
            array('name'=>'period','label'=>'期数/专项','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'mirror','label'=>'镜像持股','type'=>"choice",'choices'=>[['不适用','不适用'],['有','有'],['无','无']], 'required'=>false,),
            ...
            array('name'=>'field-index-loan','label'=>'借款', 'type'=>'seperator'),
            ...
            array('name'=>'field-index-sharehold','label'=>'股权结构', 'type'=>'seperator'),
            ...
            array('name'=>'field-index-term','label'=>'核心条款', 'type'=>'seperator'),
            array('name'=>'term_limit','label'=>'投资限制','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'term_stock_transfer_limit','label'=>'股权转让竞品限制','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'term_stock_transfer_limit_other','label'=>'股权转让其他限制','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'term_limit_other','label'=>'对投资人其他限制或责任','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'term_founder_transfer_limit','label'=>'创始人转让限制','type'=>"text", 'default'=>null,'required'=>false,),
            array('name'=>'term_holder_veto','label'=>'股东会veto','type'=>"choice",'choices'=>[['有独立veto','有独立veto'],['有不独立veto','有不独立veto'],['没有','没有'],['个别关键事项否决权','个别关键事项否决权']],'required'=>false,),
            array('name'=>'term_board_veto','label'=>'董事会veto','type'=>"choice",'choices'=>[['有独立veto','有独立veto'],['有不独立veto','有不独立veto'],['没有','没有'],['个别关键事项否决权','个别关键事项否决权']],'required'=>false),
            array('name'=>'term_preemptive','label'=>'优先认购权','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false,),
            array('name'=>'term_pri_assignee','label'=>'对创始人优先受让权','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false,),
            array('name'=>'term_sell_together','label'=>'对创始人共售权','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false,),
            array('name'=>'term_pri_common_stock','label'=>'对普通股优先权','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false,),
            ...
            array('name'=>'term_anti_dilution','label'=>'反稀释方法','type'=>"choice",'choices'=>[['完全棘轮','完全棘轮'],['狭义加权平均','狭义加权平均'],['广义加权平均','广义加权平均'],['无','无']], 'required'=>false),
            array('name'=>'term_liquidation_preference','label'=>'优先清算权方法','type'=>"choice",'choices'=>[['参与分配','参与分配'],['不参与分配','不参与分配'],['无','无']],'required'=>false),
            array('name'=>'term_drag_along_right','label'=>'拖售权','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false),
            array('name'=>'term_dar_illustrate','label'=>'拖售权说明','type'=>"text",'default'=>null,'required'=>false),
            array('name'=>'term_warrant','label'=>'warrant','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false),
            array('name'=>'term_dividends_preference','label'=>'优先分红权','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false),
            array('name'=>'term_valuation_adjustment','label'=>'对赌/估值调整','type'=>"text",'required'=>false),
            array('name'=>'term_spouse_consent','label'=>'配偶同意函','type'=>"choice",'choices'=>[['有','有'],['没有','没有']],'required'=>false),
            array('name'=>'term_longstop_date','label'=>'longstop date','type'=>"text",'required'=>false),
            array('name'=>'term_important_changes','label'=>'相对上轮重大变化','type'=>"text",'required'=>false),
            array('name'=>'term_good_item','label'=>'不常见好条款摘选','type'=>"text",'required'=>false),
            array('name'=>'field-index-arch','label'=>'Filling及Post', 'type'=>'seperator'),
            array('name'=>'arch_final_captalbe','label'=>'Final Captalbe','type'=>"choice",'choices'=>[['已存档','已存档'],['未存档','未存档']],'required'=>false),
            array('name'=>'arch_final_word','label'=>'Final Word','type'=>"choice",'choices'=>[['已存档','已存档'],['未存档','未存档']],'required'=>false),
            array('name'=>'arch_closing_pdf','label'=>'Closing PDF','type'=>"choice",'choices'=>[['已存档','已存档'],['未存档','未存档']],'required'=>false),
            array('name'=>'arch_closing_original','label'=>'Closing原件','type'=>"choice",'choices'=>[['已存档','已存档'],['未存档','未存档']],'required'=>false),
            array('name'=>'arch_overseas_stockcert','label'=>'境外股票证书','type'=>"choice",'choices'=>[['已存档','已存档'],['未存档','未存档']],'required'=>false),
            array('name'=>'arch_aic_registration','label'=>'境内工商登记','type'=>"choice",'choices'=>[['已办理','已办理'],['未办理','未办理']],'required'=>false),
            array('name'=>'pending_detail','label'=>'未决事项说明','type'=>"text",'required'=>false),
            array('name'=>'field-index-memo','label'=>'工作记录', 'type'=>'seperator'),
