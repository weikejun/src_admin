...
class PermissionActionController extends Page_Admin_Base {
    ...
    public function __construct(){
        ...
        $this->form=new Form(array(
            array('name'=>'permission_id','label'=>'权限组ID','type'=>"choosemodel",'model'=>'Model_Permission','default'=>null,'required'=>true,),
            array('name'=>'action_id','label'=>'权限ID','type'=>"choosemodel",'model'=>'Model_Action','default'=>null,'required'=>true,),
        ...
        $this->list_filter=array(
            ...
            new Page_Admin_TextForeignFilter(['name'=>'动作名','paramName'=>'name|action_id','foreignTable'=>'Model_Action','fusion'=>true]),
        );
    }
}
